...
public class BlockSandOfTimeCompressed extends BlockContainer{

	protected BlockSandOfTimeCompressed() {
		super(Material.SAND);
		this.setUnlocalizedName(RelicsOfTheSky.MODID + ".sand_of_time_compressed");
		this.setRegistryName("sand_of_time_compressed");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		// TODO Auto-generated method stub
		return new TileEntitySandOfTimeCompressed();
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
    {
    	...
    	if(tile != null && tile instanceof TileEntitySandOfTimeCompressed)
    	{
    		TileEntitySandOfTimeCompressed stile = (TileEntitySandOfTimeCompressed) tile;
